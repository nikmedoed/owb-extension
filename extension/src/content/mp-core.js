(() => {
    ...
    MP.downloadTextFile = (name, text) => {
        ...
        try {
            // Keep large exports in the page process. Sending the full text to
            // the MV3 service worker creates a huge data: URL and can stall
            // after review collection has already completed.
